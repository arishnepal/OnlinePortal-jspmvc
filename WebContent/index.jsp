          ...
          <ul class="nav navbar-nav custom_nav">
            ...
            <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Sports</a>
              <ul class="dropdown-menu" role="menu">
                <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" href="#">Politics</a> </li>
                <li><a href="#">Faq</a></li>
                <li><a href="#">Home</a></li>
                <li><a href="#">Article</a></li>
              </ul>
            </li>
            <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Business</a>
              <ul class="dropdown-menu" role="menu">
        ...
        <div class="row">
          <div class="leftbar_content">
            ...
            <div class="single_stuff wow fadeInDown">
              <div class="single_stuff_img"> <a href="pages/single.html"><img src="images/image.jpg" alt=""></a> </div>
              <div class="single_stuff_article">
                <div class="single_sarticle_inner"> <a class="stuff_category" href="#">Technology</a>
                  <div class="stuff_article_inner"> <span class="stuff_date">Nov <strong>17</strong></span>
                    <h2><a href="pages/single.html">Chabahil-Sankhu road expansion: Project faces more delay, say officials</a></h2>
                    <p>The Chabahil-Sankhu Road expansion project which was supposed to be completed by December this year is set to be delayed by at least two years due to myriad problems facing the expansion drive, road officials warn.
